...
Before running the scripts, users should configure the parameters according to their own experimental setup. In particular, please review and update the fiber parameters, SLM parameters, and optical-path parameters in the corresponding scripts.

These parameters may include the wavelength, fiber geometry, numerical aperture, SLM resolution, pixel pitch, beam size, propagation distance, and device-specific offsets. The example values in this repository are provided as references and may need to be adjusted before use.
